...
class ContinentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create continent" do
    assert_difference('Continent.count') do
      post continents_url, params: { continent: { file_name: @continent.file_name, name_en: @continent.name_en, name_pl: @continent.name_pl } }
    end
  ...
  test "should update continent" do
    patch continent_url(@continent), params: { continent: { file_name: @continent.file_name, name_en: @continent.name_en, name_pl: @continent.name_pl } }
